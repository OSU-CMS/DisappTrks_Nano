# This file is taken from the PR to add Dask and Condor support to the LPC executor.
# https://github.com/PocketCoffea/PocketCoffea/pull/462
...
class DaskExecutorFactory(ExecutorFactoryABC):
    ...
    def setup(self):
        ...
        if requested_port_raw not in (None, "", "null", "None"):
            requested_port = self._normalize_int(requested_port_raw, None)
        ...
        scaleout = self._normalize_int(self.run_options.get('scaleout', 10), 1)
